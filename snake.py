...
window = gui.Window(PROGRAM_NAME, layout, return_keyboard_events=True)
...
while True:
    ...
    if time_since_start >= 0.35:
        ...
        #draw apple
        atl,abr = convert_pos_to_cell(apple_pos)
        field.DrawRectangle(atl,abr,'red')
        
        
        #draw snake
        for index,part in enumerate(snake_body):
            tl, br = convert_pos_to_cell(part)
